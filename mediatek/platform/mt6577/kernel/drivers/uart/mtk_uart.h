...
#error NOT 6577 & 6575 Platform!!
#elif defined(CONFIG_MT6577_FPGA)
#define UART_SYSCLK                 12000000
#else
//#define UART_SYSCLK                 MTK_SYSCLK_65
//#define UART_SYSCLK                 MTK_SYSCLK_49_4
#endif
/*---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------*/
/* For MT6577, both RX and TX will not use port to send or receive data */
/* IER */
...
#define UART_MCR_DCM_EN             (1 << 5)    /* MT6577 move to bit5 */
