...
static DRIVER_ATTR(cpsopmode, S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH, show_cpsopmode_value,    store_cpsopmode_value);
static DRIVER_ATTR(cpsrange, S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH, show_cpsrange_value,    store_cpsrange_value);
static DRIVER_ATTR(cpsbandwidth, S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH, show_cpsbandwidth_value,    store_cpsbandwidth_value);
