...
static void cm36283_eint_func(void)
{
	...
	APS_ERR("debug cm36283_eint_func!");
...
/*--------------------------------------------------------------------------------*/
long cm36283_ps_operate(void* self, uint32_t command, void* buff_in, int size_in,
...
long cm36283_als_operate(void* self, uint32_t command, void* buff_in, int size_in,
		void* buff_out, int size_out, int* actualout)
{
		long err = 0;
		int value;
