...
Saturation:{
    {set:{//00 (middle saturation)
        0x00010709, 0x1020E0F0, 0x2A5A5F5A, 0x30000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E,
    }},
    {set:{//01 (middle saturation)
        0x00010709, 0x1020E0F0, 0x28545A54, 0x28000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
    {set:{//02 (middle saturation)
        0x00010709, 0x1020E0F0, 0x204E524E, 0x24000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
    {set:{//03 (middle saturation)
        0x00010709, 0x1020E0F0, 0x2E535353, 0x30000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
...
CCM:{
    {set:{//00
        ...
        0x016B0449, 0x0422044B, 0x01160035, 0x040804B2, 0x01BA0000,
    }},
    {set:{//01
        0x01B3049D, 0x04160452, 0x0116003C, 0x040804A8, 0x01B00000, 
    }},
    {set:{//02
        0x019A0459, 0x04410432, 0x013F040D, 0x04040468, 0x016C0000, 
    }}
},
Gamma:{
    {set:{//00
