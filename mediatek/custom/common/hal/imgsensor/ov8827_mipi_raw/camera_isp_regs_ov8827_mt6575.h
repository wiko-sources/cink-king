...
Saturation:{
    {set:{//00 (middle saturation)
        0x00010709, 0x1020E0F0, 0x37606760, 0x40000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
    {set:{//01 (middle saturation)
        0x00010709, 0x1020E0F0, 0x355E645E, 0x3C000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
    {set:{//02 (middle saturation)
        0x00010709, 0x1020E0F0, 0x30626A62, 0x34000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
    {set:{//03 (middle saturation)
        0x00010709, 0x1020E0F0, 0x285B615B, 0x32000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
    {set:{//04 (middle saturation)
        0x00010709, 0x1020E0F0, 0x1A555A55, 0x1A000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
...
CCM:{
    {set:{//00
        0x0177044E, 0x0429043D, 0x013C0001, 0x0005047D, 0x01780000, 
    }},
    {set:{//01
        0x01CE04AB, 0x04230439, 0x012F000A, 0x000B048E, 0x01830000, 
    }},
    {set:{//02
        0x01A9048A, 0x041F0423, 0x013A0417, 0x001A047B, 0x01610000, 
    }}
},
Gamma:{
    {set:{//00
