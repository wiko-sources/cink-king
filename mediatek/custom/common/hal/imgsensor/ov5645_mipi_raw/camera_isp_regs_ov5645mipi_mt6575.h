...
EE:{//EE
    {set:{//00 Preview ISO100 (middle sharpness)
        0x00000024, 0x0028282D, 0x00380122, 0x026D0B54, 0x0327047C, 0x037700A4, 0xFFFFFD0D, 
    }},
    ...
    {set:{//02 Preview ISO400 (middle sharpness)
        0x00000024, 0x0028282D, 0x0012004B, 0x0140067D, 0x01A002A5, 0x01C900CD, 0xFFFFFD0D, 
    }},
    {set:{//03 Preview ISO800 (middle sharpness)
        0x00000024, 0x0028282D, 0x00110050, 0x012D0582, 0x018702AA, 0x01AE00D2, 0xFFFFFD0D, 
    }},
    {set:{//04 Preview ISO1600 (middle sharpness)
        0x00000024, 0x0028282D, 0x00110056, 0x01190588, 0x016D02B0, 0x019100D8, 0xFFFFFC0D, 
    }},
    {set:{//05 Capture ISO100 (middle sharpness)
        0x00000028, 0x0037373D, 0x00380122, 0x026D0B54, 0x0327047C, 0x037700A4, 0xFFFFFD0D, 
    }},
    {set:{//06 Capture ISO200 (middle sharpness)
        0x00000028, 0x007F3721, 0x00270031, 0x01ED0963, 0x0280038B, 0x02C000B3, 0xFFFFFD0D, 
    }},
    ...
    {set:{//10  no one uses this, this is Min EE (low sharpness)
        0x00000024, 0x0037372D, 0x00050023, 0x012C0B3C, 0x020001D0, 0x020000E7, 0xFFFF0005, 
    }},
    {set:{//11 no one uses this, this is Max EE (high sharpness)
        0x0000002C, 0x00373721, 0x000A0023, 0x03202737, 0x03FF01D0, 0x03FF00E7, 0xFFFF0005 
    }}
}, 
Saturation:{
    {set:{//00 (middle saturation)
        0x00010709, 0x1020E0F0, 0x2A636A63, 0x30000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
    {set:{//01 (middle saturation)
        0x00010709, 0x1020E0F0, 0x28616861, 0x28000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
    {set:{//02 (middle saturation)
        0x00010709, 0x1020E0F0, 0x285C655C, 0x28000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
    {set:{//03 (middle saturation)
        0x00010709, 0x1020E0F0, 0x28555E55, 0x28000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
    {set:{//04 (middle saturation)
        0x00010709, 0x1020E0F0, 0x244D564D, 0x24000000, 0xFF00FF00, 0x001A2D40, 0x000A0A0A, 0x00643C1E, 
    }},
...
CCM:{
    {set:{//00
        //0x01610442, 0x041F0444, 0x01140030, 0x040704A2, 0x01A90000,
        0x010C0023, 0x042F0438, 0x01220016, 0x000504FD, 0x01F80000, 
    }},
    {set:{//01
        0x01BA049E, 0x041C0444, 0x01340010, 0x000904A2, 0x01990000, 
    }},
    {set:{//02
        0x01900465, 0x042B042F, 0x014C041D, 0x00110477, 0x01660000, 
    }}
},
Gamma:{
    {set:{//00
