...
const NVRAM_LENS_PARA_STRUCT OV5648AF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
...
UINT32 OV5648AF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &OV5648AF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pOV5648AF_getDefaultData = OV5648AF_getDefaultData;
