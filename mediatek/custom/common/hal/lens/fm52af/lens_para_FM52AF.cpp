...
const NVRAM_LENS_PARA_STRUCT FM52AF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
...
UINT32 FM52AF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &FM52AF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pFM52AF_getDefaultData = FM52AF_getDefaultData;
