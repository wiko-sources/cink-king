...
const NVRAM_LENS_PARA_STRUCT FM51AF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
...
UINT32 FM51AF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &FM51AF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pFM51AF_getDefaultData = FM51AF_getDefaultData;
