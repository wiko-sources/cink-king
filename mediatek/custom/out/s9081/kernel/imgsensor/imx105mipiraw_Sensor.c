...
*
*************************************************************************/
static void IMX105_AUTO_FOCUS_Init(void)
{
	int AFPOS=0;
	// Initail setting
	IMX105MIPI_write_cmos_sensor(0x3408, 0x02);
	IMX105MIPI_write_cmos_sensor(0x308A, 0x01);	
	IMX105MIPI_write_cmos_sensor(0x340C, 0x01);	
	// Specific pre-settings  -- Driving current 90mA
	IMX105MIPI_write_cmos_sensor(0x3081, 0x48);	
	IMX105MIPI_write_cmos_sensor(0x3401, 0x0B);	
	// Dumping setting
	IMX105MIPI_write_cmos_sensor(0x3400, 0x01);	
	IMX105MIPI_write_cmos_sensor(0x3405, 0x00);	
	IMX105MIPI_write_cmos_sensor(0x3404, 0x01);	
	// Inital position
	IMX105MIPI_write_cmos_sensor(0x3402, 0x00); 
	IMX105MIPI_write_cmos_sensor(0x3403, 0x00);	
}
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
  ...
  //  pSensorInfo->SensorCameraPreviewFrameRate=30;
    ...
    pSensorInfo->CaptureDelayFrame = 3;//2; //5
    pSensorInfo->PreviewDelayFrame = 3;//2; //5
