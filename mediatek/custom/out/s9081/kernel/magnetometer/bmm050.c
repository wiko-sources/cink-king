...
static struct i2c_board_info __initdata i2c_bmm050={ I2C_BOARD_INFO("bmm050", (BMC050_I2C_ADDRESS))};
...
static int bmm050_unlocked_ioctl(struct file *file, unsigned int cmd,unsigned long arg)
...
{
    i2c_register_board_info(0, &i2c_bmm050, 1);
