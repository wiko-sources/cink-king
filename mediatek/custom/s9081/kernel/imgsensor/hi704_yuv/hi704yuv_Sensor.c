...
{  	   
    ...
    HI704_write_cmos_sensor(0x62, 0x80);//70
    HI704_write_cmos_sensor(0x63, 0x80);//75
    ...
    HI704_write_cmos_sensor(0x20, 0x06);//SHARPENESS Black//7
    HI704_write_cmos_sensor(0x21, 0x04);//SHARPENESS White
...
{  	   
    ...
    HI704_write_cmos_sensor(0x62, 0x80);//80
    HI704_write_cmos_sensor(0x63, 0x80);//70
