...
/*
******************************************************************
void kdCISModuleChangePinConfig(int CameraIdx, int Pin, int On)
{
    printk("Ivan kdCISModuleChangePinConfig Pin = %d",Pin);
    if (On == GPIO_OUT_ZERO)
    {
	pinSet[CameraIdx][Pin+2] = GPIO_OUT_ZERO;
	pinSet[CameraIdx][Pin+3] = GPIO_OUT_ONE;	
    }
    else
    {
	pinSet[CameraIdx][Pin+2] = GPIO_OUT_ONE;
	pinSet[CameraIdx][Pin+3] = GPIO_OUT_ZERO;		
    }
    
}
EXPORT_SYMBOL(kdCISModuleChangePinConfig);
